...
namespace Fluky
{
	...
	*/
	...
	public:
		/*
		* Enumerador que representa el estado del cursor. Hidden esconde la representaci�n visual del cursor al estar dentro
		* de la ventana de la aplicaci�n, mientras que Disabled como su nombre lo indica desabilita completamente el cursor.
		*/
		...
		* La posici�n (0,0) corresponde a la esquina superior izquierda.
		*/
	...
	private:
		...
		/*
		* Funci�n llamada cada iteraci�n del motor para actualizar el estado de los eventos de input
		*/
